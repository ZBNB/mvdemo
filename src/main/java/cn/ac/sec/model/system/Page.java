...
import cn.ac.sec.util.PageData;
import cn.ac.sec.util.Tools;
...
public class Page {
	...
	public String[] getDc_ids() {
		return dc_ids;
	}
	public void setDc_ids(String[] dc_ids) {
		this.dc_ids = dc_ids;
	}
		...
		if (totalResult > 0) {
			...
			if (currentPage == 1) {
				sb.append("	<li><a>共<font color=red>" + totalResult
						+ "</font>条</a></li>\n");
				sb.append("	<li><input type=\"input\" value=\"\" id=\"toGoPage\" style=\"width:50px;height: 24px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
			...
			sb.append(">60</option>\n");
			sb.append("	<option value='70'");
			if (showCount == 70) {
				sb.append(" selected");
			}
			sb.append(">70</option>\n");
			sb.append("	<option value='80'");
			if (showCount == 80) {
				sb.append(" selected");
			}
			sb.append(">80</option>\n");
			sb.append("	<option value='90'");
			if (showCount == 90) {
				sb.append(" selected");
			}
			sb.append(">90</option>\n");
			sb.append("	<option value='99'");
			if (showCount == 99) {
				sb.append(" selected");
			}
			sb.append(">99</option>\n");
